<script type="text/javascript"> 
    ...
    $(document).ready(function() {
        table = $('#tb').DataTable( {
            ajax: "<?php echo base_url(); ?>pembelian/ajax_list_detail/<?php echo $kode; ?>"
        });
    ...
    function save(){
        ...
        if(kode_barang === ''){
            ...
            var url;
            if(save_method === 'add') {
                url = "<?php echo base_url(); ?>pembelian/ajax_add";
            } else {
            ...
            form_data.append('idpb', kode_trans);
            ...
            form_data.append('idpb_detail', kode_detail);
    ...
    function hapus(id, nama){
        if(confirm("Apakah anda yakin menghapus barang " + nama + " ?")){
            ...
            $.ajax({
                url : "<?php echo base_url(); ?>pembelian/hapusdetail/" + id,
                type: "POST",
                dataType: "JSON",
                success: function(data){
                    alert(data.status);
    ...
    function showbarang(){
        ...
        tbbarang = $('#tbbarang').DataTable( {
            ajax: "<?php echo base_url(); ?>pembelian/ajax_barang",
            retrieve:true
        });
        tbbarang.destroy();
        tbbarang = $('#tbbarang').DataTable( {
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-xs-6 col-sm-6">
                                        ...
                                        <div class="form-horizontal">
                                            <div class="form-group row">
                                                <label class="col-sm-2 col-form-label" style="text-align: right;">Note</label>
                                                <div class="col-sm-10">
                                                    
                                                    <textarea class="form-control" style="height:92px;" placeholder="Keterangan"  name="keterangan" id="keterangan"><?php echo $keterangan; ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-horizontal">
