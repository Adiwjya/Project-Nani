<script type="text/javascript"> 
    ...
    $(document).ready(function() {
        table = $('#tb').DataTable( {
            ajax: "<?php echo base_url(); ?>sales/ajax_list"
        });
    ...
    function ganti(id){
        ...
        $('.modal-title').text('Ganti Sales'); // Set title to Bootstrap modal title
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <div class="col-md-12 col-xs-12 col-sm-12">
                                    <button class="btn btn-md btn-primary" onclick="add();"> Tambah Sales</button>
            ...
            <div class="modal-body">
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-3 col-form-label" style="text-align: right;">Nama Sales</label>
                        <div class="col-sm-9">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                        <select class="form-control" id="kode_kota" name="kode_kota" onchange="getkode();">
                                <?php
