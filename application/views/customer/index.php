<script type="text/javascript"> 
    ...
    $(document).ready(function() {
        table = $('#tb').DataTable( {
            ajax: "<?php echo base_url(); ?>customer/ajax_list"
        });
    ...
    function hapus(id, nama){
        if(confirm("Apakah anda yakin menghapus " + nama + " ?")){
            ...
            $.ajax({
                url : "<?php echo base_url(); ?>customer/hapus/" + id,
                type: "POST",
                dataType: "JSON",
                success: function(data){
                    alert(data.status);
            ...
            <div class="modal-body">
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-3 col-form-label" style="text-align: right;">Nama Customer</label>
                        <div class="col-sm-9">
